	...
	Repetir
		...
		Segun opc Hacer
			...
			3 :
				...
				Escribir "Ingresa el número 1 para multiplicar: ";
				Leer num1;
				Escribir "Ingresa el número 2 para multiplicar: ";
				Leer num2;
				multiplicacion( num1, num2 );
				
			4 :
				Escribir "Elegiste hacer una DIVISIÓN!";
				Escribir "Ingresa el número 1 para dividir: ";
				Leer num1;
				Escribir "Ingresa el número 2 para dividir: ";
				Leer num2;
